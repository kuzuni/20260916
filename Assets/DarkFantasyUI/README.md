...
- All ten eras now have three named skill entries (buff, weak attack, strong attack), generated sprites, descriptions and previews. Collection icons and combat effects share `Moonlit/Combat/Skills/Tier00..Tier09/{Buff,Weak,Strong}`. Primitive companion art now includes three pets and three mounts; see the rig pipeline below for committed generated assets and pending final visual review.
